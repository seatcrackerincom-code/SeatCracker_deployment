...
# (Corrected for the duplicate Q70)
math_answers = {
...
# Keep Physics and Chemistry (ID 81-160)
physics_chem = [q for q in current_data if q['id'] > 80]
...
# Combine and save
final_data = math_questions + physics_chem

with open(target_path, 'w', encoding='utf-8') as f:
    json.dump(final_data, f, indent=2)

print(f"Successfully updated {len(math_questions)} Mathematics questions in realMock1.json.")
