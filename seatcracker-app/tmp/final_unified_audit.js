...
console.log('--- FINAL UNIFIED AUDIT ---');
console.log('Total Instances:', results.length);
console.log('Perfect Matches:', results.length - missing.length);
console.log('Missing Instances:', missing.length);
console.log('Unique Missing Chapters:', uniqueMissing.length);
if (uniqueMissing.length > 0) {
    console.log('Missing List:', JSON.stringify(uniqueMissing, null, 2));
}
